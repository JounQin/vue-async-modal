...
var NON_TRANSITION_ERR = 'this modal item is not a Vue component, you should use `transition` component and emit `after-leave` event';
    ...
    resolve: function resolve(modal) {
      ...
      return promise.then(function () {
        ...
        return new Promise(function (resolve, reject) { return this$1.$nextTick(function () {
          ...
          modalItem ? modalItem.$once('after-enter', function () { return resolve(modal); })
